...
import {truncate, LogAll, LogItemobject, LogItem, TLogItemobject, IRecord, Plugin, GenericPlugin} from '../utils';
...
export default GenericPlugin<JiraConfig>(
    {
        order: 'key',
    ...
    async function JiraPlugin(config) {
